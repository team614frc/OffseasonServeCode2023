...
public final class Constants {
  ...
  public static final class DriveConstants {
    ...
    public static final double kDirectionSlewRate = 2.6; // radians per second
    public static final double kMagnitudeSlewRate = 3.4; // percent per second (1 = 100%)
    public static final double kRotationalSlewRate = 3.6; // percent per second (1 = 100%)
